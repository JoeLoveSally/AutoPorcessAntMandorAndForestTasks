...
class PageType(str, Enum):
    ...
    MANOR_FEED_VIDEO_COMPLETE = "MANOR_FEED_VIDEO_COMPLETE"
    MANOR_FEED_FULL = "MANOR_FEED_FULL"
    MANOR_FAMILY = "MANOR_FAMILY"
    MANOR_FAMILY_WALK = "MANOR_FAMILY_WALK"
    MANOR_WALK_DONATION = "MANOR_WALK_DONATION"
    MANOR_DONATION = "MANOR_DONATION"
    MANOR_DONATION_PROJECT = "MANOR_DONATION_PROJECT"
    MANOR_DONATION_CONFIRM = "MANOR_DONATION_CONFIRM"
    MANOR_DONATION_REWARD = "MANOR_DONATION_REWARD"
    LOTTERY = "LOTTERY"
    ...
    FOREST_RAIN_RESULT = "FOREST_RAIN_RESULT"
    FOREST_FRIEND_PICKER = "FOREST_FRIEND_PICKER"
    UNKNOWN = "UNKNOWN"
